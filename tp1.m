...
colors = [blue_std,yellow_std,green_std,red_std, pinkred_std];
...
if (car_color == blue_std)&&(meanHSV(3)>0.2)&& (meanHSV(2)>0.4)
    color_out = 'BLUE';
elseif (car_color == red_std)&&(meanHSV(3)>0.2)&&(meanHSV(2)>0.4)
    color_out = 'RED';
