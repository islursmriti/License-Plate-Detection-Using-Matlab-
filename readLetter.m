...
for n=1:length(NewTemplates)
    ...
    rec=[rec sem]; % Record the value of correlation for each template's character.
    %display(sem);
    
end
vd=find(rec==max(rec)); % Find the index which correspond to the highest matched character.
